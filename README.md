...
- added 3 slots to water filtrating machine
- added 5 slots to alien contaiment
...
- Weather time - 5-30 minutes -> 3-20 minutes
- Modpack size - ~7GB -> ~8GB (with game files)
- Modpack size (without game files) - ~1.2GB -> ~1.4GB
